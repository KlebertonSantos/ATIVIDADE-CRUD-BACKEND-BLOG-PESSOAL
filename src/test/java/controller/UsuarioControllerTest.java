...
public class UsuarioControllerTest {
    ...
    public void deveAtualizarUmUsuario(){
        Optional<Usuario> usuarioCadastro = usuarioService.cadastrarUsuario(new Usuario(0L,"Juliana Andrews Raqmos","juliana_ramos@email.com.br","juliana123", "https://i.imgur.com/yDRVeK7.jpg"));
        ...
        ResponseEntity<Usuario> corpoResposta = testRestTemplate
                ...
                .exchange("/usuarios/atulizar", HttpMethod.PUT,corpoRequisicao, Usuario.class);
    ...
    public void deveMostrarTodosUsuarios(){
        usuarioService.cadastrarUsuario(new Usuario(0L,
                "Sabrina Sanches", "sabrina_sanches@emeal.com.br", "sabrina123", "https://i.imgur.com/5M2p5Wb.jpg"));
        usuarioService.cadastrarUsuario(new Usuario(0L,
